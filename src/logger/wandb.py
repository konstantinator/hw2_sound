...
class WandBWriter:
    ...
    def add_audio(self, audio_name, audio, sample_rate=None, ind=0):
        """
        ...
        self.wandb.log(
            {
                self._object_name(f'audio_{ind}'): self.wandb.Audio(
                    audio, sample_rate=sample_rate, caption=audio_name
                )
            },
            step=self.step,
        )
